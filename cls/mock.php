...
<div id="pageWrap"> 
  ...
  <div id="contentArea">
    <div class="contentDivision"> 
      <p class="breadcrumb"> <!-- InstanceBeginEditable name="breadcrumb" --> <a href="http://www.auburn.edu/career">Career Center</a> &gt;<a href="/academic/provost/undergrad_studies/career/cls/index.html">Spring 2012 Career Leadership Seminars &gt; </a>Mock Interview Registration<!-- InstanceEndEditable --> </p>
			<!-- InstanceBeginEditable name="body" -->
      <div class="thirds" style="float:left"><img src="/academic/provost/undergrad_studies/career/cls/logosmaller.png" width="220" height="111"></div>
      <div style="float:left; width:450px; height:111px">
        <h2 class="orange"> Spring 2012<br>
          Career Leadership Series<br>
           Mock Interview Registration</h2>
      </div>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
      <p><hr></p>
<div>      
  <p><span class="orange"><strong>To register for CLS Mock Interviews:</strong></span><br>
    <br>
    1.	Log-in to your Tiger Recruiting Link (TRL) account or create a new TRL account: <a href="http://www.jobs.auburn.edu">www.jobs.auburn.edu</a><br>
    <br>
    2.	Click on &quot;Events&quot; in the navy bar<br>
    <br>
    3.	Click on &quot;Workshops&quot; in the gray bar<br>
    <br>
    4.	Under the RSVP section, select a time slot (Times are offered in two rooms on two days. Please select only one slot.)<br>
    <br>
    5.	After selecting the time slot click &quot;RSVP&quot;      <br>
    <br>
  </p>
  <p class="orange"><strong>If you have a TRL account, login below.</strong></p>
  <table><form method="post" action="https://auburn-csm.symplicity.com/js_warning.php"
name="emploginform"><input type="hidden" name="skip_cookie_check" value="1"/><tr><td><div align="right">Username:</div></td><td> <input type="text" name="username" class="formtext" value=""></td></tr>
<tr><td><div align="right">Password: </div></td><td><input type="password" name="password" password class="formtext"></td></tr>
<tr><td colspan="2"><input name="submit2" type="submit" class="button"
onClick='this.form.action="https://auburn-csm.symplicity.com/students/index.php"'
value=" go "></td></tr></form></table>
</div>
      <!-- InstanceEndEditable -->
      <p class="lastUpdated">Last Updated: <!-- InstanceBeginEditable name="lastUpdated" -->Jan. 24, 2012<!-- InstanceEndEditable --> </p>
    </div>
    <div class="sidebar"> 
