...
<!-- TemplateBeginEditable name="head" --><!-- TemplateEndEditable --><!-- TemplateParam name="picture" type="boolean" value="true" --><!-- TemplateParam name="photo" type="boolean" value="true" --><!-- TemplateParam name="Photo" type="boolean" value="true" -->
</HEAD>
<BODY>
      ...
      <table width="750" border="0" cellspacing="0" cellpadding="10">
        <tr>
          <td width="200" valign="top"><div align="center">
            <p><a href="https://auburn-csm.symplicity.com/" target="_blank"></a><img src="../images/cdslogotheme.jpg" alt="CDS - Explore Prepare Succeed" width="170" height="90"></p>
            <!-- TemplateBeginEditable name="linktitle" -->
            <p class="cdsheads">Quick Links </p>
            <!-- TemplateEndEditable --></div>
            <!-- TemplateBeginEditable name="links" -->
            <?php include "qlinks.htm"; ?>
            <!-- TemplateEndEditable --></td>
          <td width="550" valign="top"><!-- TemplateBeginEditable name="Body" -->Body<!-- TemplateEndEditable --></td>
        </tr>
      </table>
      <br>
      <table width="750" border="0" align="center" cellpadding="2" cellspacing="0" bgcolor="#f9903f">
...
Regulations</A></TD></TR></TBODY></TABLE></BODY></HTML>
