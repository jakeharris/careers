...
module.exports = function (grunt) {
  ...
  var VIEW_MAPPING = {
    ...
    'students/events/stem.html': ['<%= config.views %>/events-pages/stem.hbs'],
    ...
    'employers/part-time-employment.html': ['<%= config.views %>/part-time-employment.hbs'],
    'employers/recruiting.html': ['<%= config.views %>/recruiting.hbs'],
    'employers/info-sessions.html': ['<%= config.views %>/info-sessions.hbs'],
    ...
    'auburn-on-the-hill/index.html': ['views/auburn-on-the-hill/index.hbs'],
    'auburn-on-the-hill/about.html': ['views/auburn-on-the-hill/about.hbs']
  },
  VIEW_MAPPING_PROD = {
    ...
    'dist/employers/part-time-employment.html': ['<%= config.views %>/part-time-employment.hbs'],
    'dist/employers/recruiting.html': ['<%= config.views %>/recruiting.hbs'],
    'dist/employers/info-sessions.html': ['<%= config.views %>/info-sessions.hbs'],
    ...
    'dist/auburn-on-the-hill/index.html': ['views/auburn-on-the-hill/index.hbs'],
    'dist/auburn-on-the-hill/about.html': ['views/auburn-on-the-hill/about.hbs']
  }
