...
module.exports = function (grunt) {
  ...
  var VIEW_MAPPING = {
    ...
    'majors/index.html': ['<%= config.views %>/majors.hbs'],
  ...
  VIEW_MAPPING_PROD = {
    ...
    'dist/majors/index.html': ['<%= config.views %>/majors.hbs'],
  ...
  grunt.initConfig({
    ...
    watch: {
      assemble: {
        files: ['<%= config.views %>/{,*/}*.{md,hbs,yml}', '<%= config.assets %>/data/staff.json', '<%= config.assets %>/data/majors.json'],
