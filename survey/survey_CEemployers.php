      ...
      <table width="750" border="0" cellspacing="0" cellpadding="10">
        <tr>
          <td valign="top"><!-- InstanceBeginEditable name="Body" -->
            <p><span class="cdsheads">CAREER EXPO SPRING 2008  </span><br />
              Career Expo is a significant  service provided by Career Development Services (CDS). Our records indicate you recently attended a program conducted by a represenative from CDS. In an effort to make  sure we are meeting your needs, we would like you to answer a  few questions to let us know about your experience at our Career Expo. Please take a few moments to fill out this questionnaire and feel  free to add your  comments at the end. We look forwarding to serving you in the future. </p>
            <p>Thank you.</p>
            <hr>
              <p><strong>All Information will be kept confidential and used only to improve services. </strong></p>
              <form id="form1" name="form1" method="post" action="actionCEemployers.php">
  <table width="649" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="649">&nbsp;</td>
    </tr>
    <tr>
      <td>1. Pre-Registration <br />
        <table width="633">
          <tr>
            <td width="20"><label>
              <input type="radio" name="one" value="1" />
            </label></td>
              <td width="136"> Excellent </td>
              <td width="20"><label>
    ...
    <tr>
      <td><br>
        4. Event Hospitality Services (name tags, information, etc.) <br />
        <table width="633">
          <tr>
            <td width="20"><label>
            ...
            <td width="136">Excellent </td>
            <td width="20"><label>
              <input type="radio" name="fou" value="2" />
            </label></td>
            <td width="65"> Good </td>
            <td width="20"><label>
              <input type="radio" name="fou" value="3" />
            </label></td>
            <td width="96"> Fair </td>
            <td width="21"><label>
	...
	<tr>
      <td><br>
        5. Student Interaction &amp; Preparation <br />
        <table width="633">
          <tr>
            <td width="20"><label>
	...
	<tr>
      <td><br>
        7. Assistance from Career Development Services Staff <br />
        <table width="633">
          <tr>
            <td width="20"><label>
    ...
    <tr>
      <td><p><br>
        11. How did you hear about Career Expo? <br />
        <textarea name="how" cols="75" id="how"></textarea>
      </p>
        </td>
    </tr>
	<tr>
      <td><p><br>
        12. Please share your comments about Career Expo.<br />
        <textarea name="comments" cols="75" id="comments"></textarea>
      </p>
        <p>
          <input name="date" type="hidden" value="<? echo $date=date("m/d/y   h:i A"); ?>">
</p></td>
    </tr>
    <tr>
