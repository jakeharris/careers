...
<TABLE cellSpacing=0 cellPadding=0 width=770 align=center border=0>
  ...
  <tr>
    <th scope="col"><h2 class="style1">Thank you for taking the time to help us out! </h2>
...
$query="INSERT INTO survey2 (id, college, class, gender, reason, other, six, seven, eight, nine, ten, eleven, comments) VALUES (
         '$id',
		 '$college',
		 '$class',
		 '$gender',
...
//subject
$subject = "Career Counseling Satisfaction Survey";

//message

$message=

"<table><tr><td colspan=3><center>Career Counseling Satisfaction Survey</center></td></tr>
<tr><td>College</td><td>&nbsp</td><td> $college</td></tr>
<tr><td>Class:</td><td>&nbsp</td><td> $class</td></tr>
<tr><td>Gender:</td><td>&nbsp</td><td> $gender</td></tr>
