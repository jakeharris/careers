      ...
      <table width="750" border="0" cellspacing="0" cellpadding="10">
        <tr>
          <td valign="top"><!-- InstanceBeginEditable name="Body" -->
            <p><span class="cdsheads">Job Search Assistance  </span><br />
              Job search assistance is a significant  service provided by Career Development Services (CDS). In an effort to make  sure we are meeting the needs of our students, we would like you to answer a  few questions to let us know about your meeting with a counselor. Please take  a few moments to fill out this questionnaire and feel free to add your  comments at the end.  We look forward to serving you in the future. Thank you.</p>
              <hr>
              <p><strong>All Information will be kept confidential and used only to improve services. </strong></p>
              <form id="form1" name="form1" method="post" action="actionjob.php">
  <table width="672" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="672">&nbsp;</td>
    </tr>
    <tr>
      <td><p>1. Why did you visit Career Development Services? <strong>(Check all that apply)</strong>:</p>
        <table width="662" border="0">
                  <tr>
                    <td width="20"><input name="reason1" type="checkbox" id="reason1" value="1"></td>
                    <td width="153">Career Fair Preparation </td>
                    <td width="20"><input name="reason2" type="checkbox" id="reason2" value="1"></td>
                    <td width="173">Cover Letter Assistance </td>
                    <td width="20"><input name="reason3" type="checkbox" id="reason3" value="1"></td>
                    <td width="250">Internships</td>
                  </tr>
                  <tr>
                    <td><input name="reason4" type="checkbox" id="reason4" value="1"></td>
                    <td>Interview Skills  </td>
                    <td><input name="reason5" type="checkbox" id="reason5" value="1"></td>
                    <td>Job Search  </td>
                    <td><input name="reason6" type="checkbox" id="reason6" value="1"></td>
                    <td>Mock Interview </td>
                  </tr>
                  <tr>
                    <td><input name="reason7" type="checkbox" id="reason7" value="1"></td>
                    <td>Negotiating Job Offers  </td>
                    <td><input name="reason8" type="checkbox" id="reason8" value="1"></td>
                    <td>Resume Assistance </td>
                    <td><input name="reason9" type="checkbox" id="reason9" value="1"></td>
                    <td>Part-Time Student Employment </td>
                  </tr>
                  <tr>
                    <td><input name="reason10" type="checkbox" id="reason10" value="1"></td>
                    <td>Summer Job </td>
                    <td><input name="reason11" type="checkbox" id="reason11" value="1"></td>
                    <td>Tiger Recruiting Link </td>
                    <td><input name="reason12" type="checkbox" id="reason12" value="1"></td>
                    <td>Graduate School Exploration </td>
                  </tr>
                  <tr>
                    <td><input name="reason13" type="checkbox" id="reason13" value="1"></td>
                    <td>Other</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                  ...
                  <tr>
                    <td colspan="6">2. How did you find out about CDS? <strong>(Check all that apply)</strong> </td>
                    </tr>
                  <tr>
                ...
                <p></p>    </tr>
    <tr>
      <td>        3. I was very satisfied with the job search assistance I received at CDS. <br />
        <table width="633">
          <tr>
            <td width="20"><label>
    ...
    <tr>
      <td>4. My career counselor was effective in providing me with tools and information to answer my questions. <br />
        <table width="633">
          <tr>
            <td width="20"><label>
    ...
    <tr>
      <td><br>
        5. As a result of the job search assistance I received, I am more confident about my ability to acquire a job. <br />
        <table width="633">
          <tr>
            <td width="20"><label>
    ...
    <tr>
      <td><br>
        7. I would recommend Career Development Services to other students. <br />
        <table width="633">
          <tr>
            <td width="20"><label>
