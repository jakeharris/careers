...
<div id="pageWrap"> 
  ...
  <div id="contentArea">
    <div class="contentDivision"> 
      <p class="breadcrumb"> <!-- InstanceBeginEditable name="breadcrumb" --> <a href="http://www.auburn.edu/career">Career Center</a> &gt; <a href="/academic/provost/undergrad_studies/career/assessments/index.html">Assessments &gt;</a> Group Reschedule<!-- InstanceEndEditable --> </p>
...
mysql_connect("acadmysql","cdsserv","career") or die("Unable to connect to server");
	...
	$query="INSERT INTO assessments (id, fname, lname, email, date, Monday, Tuesday, Wednesday, Thursday, Friday) VALUES (
         '$id',
         '$fname',
         '$lname',
		 '$email',
...
?>
<table width="535" border="0" cellspacing="3" cellpadding="2">
  <tr>
    <td><div align="center">Your request for a group session has been submitted.</div></td>
  </tr>
</table>
      <!-- InstanceEndEditable -->
      <p class="lastUpdated">Last Updated: <!-- InstanceBeginEditable name="lastUpdated" --> Jan. 13, 2012<!-- InstanceEndEditable --> </p>
    </div>
    <div class="sidebar"> 
