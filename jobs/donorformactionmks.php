...
$query="INSERT INTO donor (ID, checkbox1, checkbox2, checkbox3, checkbox4, checkbox5, checkbox6, checkbox7, checkbox8, checkbox9, checkbox10, checkbox11, name, email, company, phone, street, city, state, zip) VALUES (
         '$ID',
		 '$checkbox1',
		 '$checkbox2',
		 '$checkbox3',
...
/* donation */
$donation = "$checkbox1 $checkbox2 $checkbox3 $checkbox4 $checkbox5 $checkbox6 $checkbox7 $checkbox8 $checkbox9 $checkbox10 $checkbox11";
...
Attn: Melvin K. Smith<br>
303 Mary Martin Hall<br>
Auburn University, AL 36849</p>

<p>All donations should be received by Friday, March 28. Please feel free to call or email about questions. </p>

<p>Thank you and War Eagle,</p>

Melvin K. Smith<br><br>
Career Development Services<br>
Auburn University<br>
(334) 844-4744<br>
smithmk@auburn.edu<br>
";
              ...
              <tr>
                ...
                <td width="292"><p>Your support and donation for the Student Employee of the  Year luncheon is greatly appreciated! We would not be able to host this  wonderful recognition program without your help!!!</p>
                  ...
                  <p>Melvin K. Smith <br>
                    ...
                    (334) 844-4744<br>
  <a href="mailto:smithmk@auburn.edu">smithmk@auburn.edu</a></p>
                  </td>
              </tr>
            </table>
            <p>&nbsp;</p>
