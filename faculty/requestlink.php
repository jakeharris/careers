...
<div id="pageWrap"> 
  ...
  <div id="contentArea">
    <div class="contentDivision"> 
      <p class="breadcrumb"> <!-- InstanceBeginEditable name="breadcrumb" --> <a href="http://www.auburn.edu/career">Career Center &gt;</a> <a href="http://www.auburn.edu/career/faculty">Faculty &gt;</a> Presentation Submitted<!-- InstanceEndEditable --> </p>
...
$query="INSERT INTO presentationsredo (ID, topic, type, date, day, start, am1, pm1, end, am2, pm2, course, section, attend, orgname, location, internet, description, contact, pemail, poffice, pcell, secondary, semail, soffice, scell) VALUES (
         '$ID',
		 '$topic',
		 '$type',
		 '$date',
...
<b>Start time:</b> $start $am1 $pm1<br>
<b>End time:</b> $end $am2 $pm2<br>
<b>Location:</b> $location<br>
<b>Description:</b> $description<br>
<b>Organization/Course # - Section #:</b> $course<br>
<b>Expected Attendance:</b> $attend<br>
...
?>       
	  ...
	  <!-- InstanceEndEditable -->
      <p class="lastUpdated">Last Updated: <!-- InstanceBeginEditable name="lastUpdated" --> Jun 7, 2013<!-- InstanceEndEditable --> </p>
    </div>
    <div class="sidebar"> 
