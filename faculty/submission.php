...
<html lang="en" ng-app="">
  <head>
    ...
    <!-- Application CSS -->
    <!-- build:css assets/styles/presentations.min.css -->
...
<![endif]-->
    ...
    <!-- build:js assets/scripts/presentations.min.js -->
...
<section class="content">  
  <p>
    ...
    <?php
      ...
      "<p>The following information has been submitted for a presentation. If you are not contacted by someone in the Career Center office within 2 business days, please call 334.844.4744 to confirm your request.</p>
      <br /><br />
      <p>
