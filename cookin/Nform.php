      ...
      <td colspan="2"><table width="672" border="0">
        ...
        <tr>
          <td align="center" valign="top"><strong class="form">Representatives Present? <br> <label>
                <input type="checkbox" name="cookinrep" value="yes" id="smokinrep_0" />
          </label>
          </strong>
            <label>            Yes</label> 
              &nbsp;
              <label>
                <input type="checkbox" name="cookinrep" value="no" id="smokinrep_1" />
                No</label></td>
          <td align="center" valign="top"><strong class="form">Representatives Present? <br> <label>
            ...
            <label>            Yes</label> 
              &nbsp;
              <label>
                <input type="checkbox" name="smokinrep" value="no" id="smokinrep_1" />
                No</label></td>
  ...
  <input name="sizzlin" type="text" id="sizzlin" size="10" />
        ...
        <tr>
          <td align="center" valign="top"><span class="form"><strong>Display Table?</strong><br>
              ...
              <span class="form">
                <label>
                  <input type="checkbox" name="cookintable" value="yes" id="sizzlintable_0">
                  Yes</label>
                
                <label>
                  <input type="checkbox" name="cookintable" value="no" id="sizzlintable_1">
                  No</label>
          ...
          <td align="center" valign="bottom"><span class="form"><strong>Display Table?</strong><br>
              ...
              <span class="form">
                <label>
                  <input type="checkbox" name="sizzlintable" value="yes" id="sizzlintable_0">
                  Yes</label>
                
                <label>
                  <input type="checkbox" name="sizzlintable" value="no" id="sizzlintable_1">
                  No</label>
