...
<div id="pageWrap"> 
  ...
  <div id="contentArea">
    <div class="contentDivision"> 
      <p class="breadcrumb"> <!-- InstanceBeginEditable name="breadcrumb" --> <a href="http://www.auburn.edu/career">Career Center</a> &gt; Student Employment Paperwork Search<!-- InstanceEndEditable --> </p>
			<!-- InstanceBeginEditable name="body" -->
      <form name="form1" method="post" action="http://hire.auburn.edu/paperworksearchaction.php">
  Last Name: 
  <label>
    <input type="text" name="last" id="last">
  </label>
  <br><?php
	//$link = mysql_connect('acadmysql.duc.auburn.edu', 'cdsserv', 'career') or die("Unable to connect to server");	//('localhost', 'mysql_user', 'mysql_password')
	//if (!$link) {
	...
	//{
		//$Major = "Edu";
		//mysql_select_db("gisignup");
		//$query = "SELECT last, first, date FROM paperworkform WHERE last= $last ;
	//}
