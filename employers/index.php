...
<HTML><!-- InstanceBegin template="/Templates/general.dwt.php" codeOutsideHTMLIsLocked="false" --><HEAD>
...
<TABLE cellSpacing=0 cellPadding=0 width=770 align=center border=0>
  ...
  <TR>
    <TD width=205 height=110 align=middle valign="top" bgColor=#03244d>
      ...
      src="http://www.auburn.edu/career/templates/ddLogoEmblem2.gif" 
      ...
      <table width="750" border="0" cellspacing="0" cellpadding="10">
        <tr>
          <td width="200" valign="top"><div align="center">
            <p><img src="../images/cdslogotheme.jpg" alt="Tiger Recruiting Link" width="170" height="90" border="0"></p>
            <p class="cdsheads">Quick Links </p>
            </div><?php include "qlinks.htm"; ?></td>
          <td width="550" valign="top"><!-- InstanceBeginEditable name="Section Title" --><span class="cdsheads">EMPLOYERS</span><!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Body" -->
            <table width="520" border="0" cellspacing="0" cellpadding="5">
              <tr>
                <td width="290" valign="top"><p align="left"><div style="float: right;"><IMG SRC="../images/karenleigh.jpg"></div>Welcome to Auburn University's Career Development Services listing of   services, events, programs, and information which can aid your organization in   recruiting Auburn   University students and   alumni.</p>
                  <p align="left"> Through Career Development Services, employers can effectively connect   to students, more easily identify potential candidates, and greatly increase   their company's visibility.</p>
                  <p align="left" class="cdsheads">Recruiting at Auburn </p>
                  <ul class="cdslistunderline">
                    <li><a href="ocr.php" class="cdslist">On-Campus Recruiting Information</a></li>
                    <li><a href="trl.php" class="cdslist">Tiger Recruiting Link (TRL)</a></li>
                    <li><a href="../events/index.php" class="cdslist">Upcoming Special Events</a><br>
                    </li>
                  </ul>
                  <p align="left">&nbsp;</p>
                  <p align="left">&nbsp;</p>
                  </p></td>
                <td width="220" valign="top"><?php include "./upcoming.html"; ?></td>
              </tr>
              <tr>
...
urchinTracker();
      ...
      <table width="750" border="0" align="center" cellpadding="2" cellspacing="0" bgcolor="#f9903f">
        <tr>
          <td><div align="center"><a href="http://www.auburn.edu/student_info/student_affairs/success/support/" class="cdsmenulinkstop">Academic Support </a></div></td>
