...
<div id="pageWrap"> 
  ...
  <div id="contentArea">
    <div class="contentDivision"> 
      <p class="breadcrumb"> <!-- InstanceBeginEditable name="breadcrumb" --> <a href="http://www.auburn.edu/career">Career Center</a> &gt; Student Employment Hiring Paperwork<!-- InstanceEndEditable --> </p>
			<!-- InstanceBeginEditable name="body" -->
      <form action="http://hire.auburn.edu/paperworkformaction.php" method="post" name="paperwork" id="paperwork">
  <table width="520" border="0">
    <tr>
      <td colspan="2" class="cdsheadssmaller">Student Employment Hiring Paperwork</td>
      </tr>
    <tr>
      <td bgcolor="#FFCC99"><strong>Last:</strong><label>
  <input type="text" name="last" id="last">
</label></td>
      <td bgcolor="#FFCC99"><strong>First:</strong><label>
  <input type="text" name="first" id="first">
    ...
    <tr>
      <td>Approved:
        <label>
          <input name="approved" type="checkbox" id="approved" value="approved">
          <input name="date" type="hidden" id="date" value="<? echo $date=date("m/d/y   h:i A"); ?>">
        </label></td>
      <td>By: 
        <label>
          <input name="initials" type="checkbox" id="initials" value="KK">
          KK &nbsp;&nbsp;
          <input name="initials" type="checkbox" id="initials" value="HH">
          HH
          &nbsp;
          <input name="initials" type="checkbox" id="initials" value="JT">
          JT
          &nbsp;
          <input name="initials" type="checkbox" id="initials" value="CM">
          CM</label></td>
    </tr>
    <tr>
      <td bgcolor="#FFCC99"><strong>Missing Form(s):</strong><br>
        <label>
          <input type="checkbox" name="forms1" value="PDF" id="forms_0">
          PDF</label>
        <br>
        <label>
<input type="checkbox" name="forms2" value="A4" id="forms_1">
A4</label>
        <br>
        <label>
          <input type="checkbox" name="forms3" value="W4" id="forms_2">
          W4</label>
        <br>
        <label>
<input type="checkbox" name="forms4" value="I9" id="forms_3">
I9</label>
        <br>
        <label>
<input type="checkbox" name="forms5" value="SSC" id="forms_4">
SSC</label>
        <br>
        <label>
<input type="checkbox" name="forms6" value="license" id="forms_5">
License</label>
          <br>
          <label>
            <input type="checkbox" name="forms7" value="direct deposit" id="forms_6">
            Direct Deposit</label>        <br></td>
      <td valign="top" bgcolor="#FFCC99"><p><strong>Missing Signature:</strong><br>
<label>
  <input type="checkbox" name="signatures" value="Students" id="signatures_0">
            Students</label>
          <br>
          <label>
<input type="checkbox" name="signatures" value="Dean" id="signatures_1">
Dean</label>
            <br>
          <label>
<input type="checkbox" name="signatures" value="Both" id="signatures_3">
Both</label>
        </p>
        <p><strong>Incorrect Dates:</strong><br>
          <label>
            <input type="checkbox" name="dates" id="dates" value="dates">
          </label>
          Signature Dates<br>
        </p></td>
    </tr>
    <tr>
      <td colspan="2"><strong>Other:</strong><br>
        <label>
  ...
  <p>&nbsp;</p>
  <p><a href="http://www.auburn.edu/career/employers/paperworksearch.php">Search for a Student's Paperwork</a></p>
      </form>
      <!-- InstanceEndEditable -->
      <p class="lastUpdated">Last Updated: <!-- InstanceBeginEditable name="lastUpdated" --> May 21, 2013<!-- InstanceEndEditable --> </p>
    </div>
    <div class="sidebar"> 
