...
<div id="pageWrap"> 
  <div id="headerWrap">
    <div id="header">
      ...
      <tr>
        <tr>
        <td><a href="/academic/provost/undergrad_studies/career/students">Students</a></td>
        <td><a href="http://hire.auburn.edu">Employers</a></td>
        <td><a href="/academic/provost/undergrad_studies/career/alumni">Alumni</a></td>
        <td><a href="/academic/provost/undergrad_studies/career/faculty">Faculty/Staff</a></td>
        <td><a href="/academic/provost/undergrad_studies/career/parents">Parents</a></td>
        <td><a href="/academic/provost/undergrad_studies/career/aboutus">About Us</a></td>
      </tr>
      </tr>
    </table>
  </div>
  <div id="contentArea">
    <div class="contentDivision"> 
      <p class="breadcrumb"> <!-- InstanceBeginEditable name="breadcrumb" --> <a href="http://www.auburn.edu/career">Career Center</a> &gt; Student Employment Paperwork Search Results<!-- InstanceEndEditable --> </p>
			<!-- InstanceBeginEditable name="body" -->
     <p>
       <?php
	$link = mysql_connect('acadmysql.duc.auburn.edu', 'cdsserv', 'career') or die("Unable to connect to server");
	mysql_select_db("gisignup") or die ("Unable to select database");


	$query = "SELECT last, first, date, approved, date FROM paperworkform WHERE last= '$last'";
	$result = mysql_query($query) or die(mysql_error());
	
		
	echo "<table border=3 cellpadding=3>\n";

echo "<tr><td>Last</td><td>First</td><td>Date</td><td>Approved</td><td>Sent to HR</td></tr>\n";
...
?>
     ...
     <p>&nbsp; </p>
     <p><a href="http://hire.auburn.edu/paperworksearch.php" class="gametitles">Search Again</a></p>
      <!-- InstanceEndEditable -->
...
<div id="footerWrap">
    ...
    <div id="footSectionWrap">
      ...
      <div class="footSection"> 
        <ul>
          <br>
            <a href="www.facebook.com/aucareer"><img src="/academic/provost/undergrad_studies/career/buttons/icofacebook.png" alt="Facebook" width="25" height="25" border="0"></a> &nbsp;<a href="http://twitter.com/#!/AUCareer"><img src="/academic/provost/undergrad_studies/career/buttons/icotwitter.png" alt="Twitter" width="25" height="25" border="0">&nbsp; </a> <a href="http://www.youtube.com/user/AUCDS"><img src="/academic/provost/undergrad_studies/career/images/icoyoutube.png" alt="YouTube" width="25" height="25" border="0"></a>&nbsp;<a href="http://www.linkedin.com/groups?about=&gid=1878262" target="_blank"><img src="/academic/provost/undergrad_studies/career/buttons/icolinked.png" alt="LinkedIn" width="25" height="25" border="0"></a> <a href="http://tigersprepare.blogspot.com/" target="_blank">&nbsp;<img src="/academic/provost/undergrad_studies/career/buttons/icoblog.png" alt="Blog" width="25" height="25" border="0"></a></li>
        </ul>
      </div>
